...
export const simplePlugins = 'lists image link fullscreen code'

export const simpleToolbar = [
  'undo redo styles  bold italic alignleft aligncenter alignright alignjustify bullist numlist outdent indent lists image link fullscreen code',
]
