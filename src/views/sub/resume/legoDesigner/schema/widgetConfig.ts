import type { IWidgetTab } from '../types'
...
export const WIDGET_CONFIG_LIST: Array<IWidgetTab> = [
  ...
  },
  {
    title: '评分',
    category: 'rate',
    icon: 'iconify-ri:star-half-line',
    dataSource: {
      rateValue: 3, // 评级
    },
    list: [
  ...
  },
  {
    title: '日期',
    category: 'date',
    icon: 'iconify-ri:calendar-2-line',
    dataSource: {},
    list: [
      {
        id: '', // 组件唯一性id
  ...
  },
  {
    title: '图标',
    category: 'icon',
    icon: 'iconify-ri:search-eye-line',
    dataSource: {},
    list: [],
  },
  {
    title: '列表',
    category: 'li',
    icon: 'iconify-ri:file-list-line',
    dataSource: {},
    list: [],
  },
  {
    title: '其他',
    category: 'other',
    icon: 'iconify-ri:pencil-ruler-2-line',
    dataSource: {},
    list: [
      {
        id: '', // 组件唯一性id
